"""
ml_regression_tasks_dataset2_scratch.py

Dataset2 (Drug Review) regression energy measurement using from-scratch
(non scikit-learn) Python implementations. Structurally identical to
../d3_cls/ml_regression_tasks_dataset2_rerun.py (same DATA_PATH_TRAIN/TEST
files, same 215,063-row combined dataset, same training_features/target, same
RANDOM_STATE/60-20-20 split, same tags/output-CSV shape) and to
ml_regression_tasks_dataset1_scratch.py (same algorithm implementations,
...
OUTPUT_CSV = "output_ml_regression_drug_scratch.csv"
RANDOM_STATE = 42
N_REPETITIONS = 10
SLEEP_SECONDS = 30
...
# ../d3_cls/ml_regression_tasks_dataset2_rerun.py.
# ---------------------------------------------------------------------------
